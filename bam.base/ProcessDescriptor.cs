...
{
    [Serializable]
    public class ProcessDescriptor : IKeyedAuditRepoData
    {
        ...
        public virtual IClient LocalClient { get; set; }
        ...
        public static ProcessDescriptor ForApplicationRegistration(IApplicationRegistrationRepository repo, string serverHost, int port, string applicationName, string organizationName = null)
        {
