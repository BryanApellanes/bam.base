...
namespace Bam.Net.Data.Repositories
{
	public class MetaProperty : IMetaProperty
	{
		...
		public IMetaPropertyVersionInfo[] GetVersionInfos()
		{
			return Versions.Select(ver => GetVersionInfo(ver)).ToArray();
		}

		public IMetaPropertyVersionInfo GetVersionInfo()
		{
			return GetVersionInfo(HighestVersion);
		}

		public IMetaPropertyVersionInfo GetVersionInfo(int version)
		{
			IMetaPropertyVersionInfo info = new MetaPropertyVersionInfo 
			{ 
				Hash = Meta.Hash,
